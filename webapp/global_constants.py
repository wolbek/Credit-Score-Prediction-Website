grade = ["A", "B", "C", "D", "E","F","G"]
# home_ownership = ["RENT", "OTHER", "NONE", "ANY", "OWN", "MORTGAGE"]
home_ownership = ["MORTGAGE", "NONE", "OTHER", "OWN", "RENT"]
# addr_state = ["ND","NE","IA","NV","FL","HI","AL", "NM","VA", "NY", "OK","TN","MO","LA","MD","NC", "CA", "UT","KY","AZ","NJ", "AR","MI","PA","OH","MN", "RI","MA","DE","SD","IN", "GA","WA","OR", "WI","MT", "TX", "IL","CT", "KS","SC","CO","VT","AK","MS", "WV","NH","WY","DC","ME","ID"]
